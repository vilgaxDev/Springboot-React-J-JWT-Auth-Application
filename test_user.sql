...
values (nextval('sq_simple_auth_user'), 'user1', '$2a$12$wWa8P0wPNm1.JLTP5Yavnu0xnp1tMT4Bqt2NI7eJJmyIM671MI0ki', true);

insert into simple_auth_user_attribute(user_id, key, value)
values (currval('sq_simple_auth_user'), 'email', 'user.1@test.com');
insert into simple_auth_user_attribute(user_id, key, value)
